    ...
    return (
        <div className="pb-12">
            ...
            <div className="flex gap-4 border-b border-primary/10 mb-4">
                <button className="pb-2 border-b-2 border-primary text-primary font-semibold text-sm transition-colors">Surah</button>
                <button className="pb-2 border-b-2 border-transparent text-slate-500 dark:text-slate-400 font-medium text-sm hover:text-primary/70 transition-colors">Juz</button>
                <button className="pb-2 border-b-2 border-transparent text-slate-500 dark:text-slate-400 font-medium text-sm hover:text-primary/70 transition-colors">Bookmarks</button>
            </div>
